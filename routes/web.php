...
Route::get('/classificacao', 'App\Http\Controllers\ClassificacaoController@index')->name('classificacao');
Route::post('/salvaRodada', 'App\Http\Controllers\ClassificacaoController@salvaRodada');
Route::get('/getRodada', 'App\Http\Controllers\ClassificacaoController@getRodada');
Route::get('/getClassificacao', 'App\Http\Controllers\ClassificacaoController@getClassificacao');
